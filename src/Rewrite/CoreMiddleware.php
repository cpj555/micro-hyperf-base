...
{
    protected function handleNotFound(ServerRequestInterface $request): void
    {
        throw new SystemException(Code::HANDLE_NOT_FOUND);
    }

    protected function handleMethodNotAllowed(array $methods, ServerRequestInterface $request): void
    {
